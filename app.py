...
def api_discovered_businesses():
    ...
    try:
        ...
        for biz in histories:
            #    ( )
            monthly_revenue = biz.total_score * 100000  #  * 10
            annual_revenue = monthly_revenue * 12
            investment = biz.total_score * 50000  #  * 5
            ...
            business_list.append({
                ...
                'description': f"{biz.business_name} -  {int(biz.market_score)},  {int(biz.revenue_score)}",
    ...
    try:
        ...
        for row in result:
            ...
            business_list.append({
                ...
                'description': f"{row.business_name} -  {int(row.market_score)},  {int(row.revenue_score)} ( )",
